...
+ **Camera**: 
  ...
  + We store some necessary parameters to uniquely define a perspective camera in **.xml** file:
    ...
    - *fovy*: The field-of-view on the y-axis of camera, the unit is **degrees**.
...
### Cornell-Box with Material Ball
![cornel-box-with-matball.png](cornell-box.png)
### Bathroom2
![bathroom2.png](bathroom2.png)
